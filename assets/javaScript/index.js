...
var vocabularyEnglish = [
  ...
  ["Account for", "v) chiếm", "Gợi ý: Account for", "ChinBacNuiRung.jpg"],
  ["Diverse", "adj) đa dạng", "Gợi ý: Diverse", "PhotDoi.jpg"],
  [
    "Majority",
    "n) đa số",
    "Gợi ý: Majority",
  ...
  ["Minority", "n) thiểu số", "Gợi ý: Minority", "Thanh_ngu.png"],
  ["Gather", "v) tụ tập, tập trung", "Gợi ý: Gather", "khaigiang8A6_2022.png"],
  [
    "Museum of Ethnology",
  ...
  ["Curious about", "adj) tò mò về", "Gợi ý: Curious about ", "tapthe8A6.png"],
  ["Customs", "n) phong tục", "Gợi ý: Customs", "trungthu2022.png"],
  ["Stilt house", "n) nhà sàn", "Gợi ý: Stilt house", "Dai_Nhan.png"],
  ["Communal house", "n) đình làng, nhà rông", "Gợi ý: Communal house", "3"],
  ["Pagoda", "n) chùa", "Gợi ý: Pagoda", "3"],
  ["Temple", "n) đền", "Gợi ý: Temple", "3"],
  ["Ceremony", "n) nghi lễ", "Gợi ý: Ceremony", "3"],
  ["Festival", "n) Lễ hội", "Gợi ý: Festival ", "3"],
  ["Shawl", "n) Khăn phiêu", "Gợi ý: Shawl", "3"],
  ["Waterwheel", "n) cối xay nước, cọn nước", "Gợi ý: Waterwheel", "3"],
  ["Terraced field", "n: ruộng bậc thang", "Gợi ý: Terraced field", "3"],
  ["Open-air market", "n: chợ ngoài trời", "Gợi ý: Open-air market", "3"],
  ["Cultivation", "n) việc cày cấy, trồng trọt", "Gợi ý: Cultivation", "3"],
  ["Plough", "v: Cày", "Gợi ý: Plough", "3"],
  [
  ...
  ["Spin thread", "v.phr) kéo sợi", "Gợi ý: Spin thread", "3"],
  ["Dye", "v: nhuộm", "Gợi ý: Dye", "3"],
  ["Weave", "v) đan, dệt (vải, thảm, ...)", "Gợi ý: Weave", "3"],
  ["Embroidery", "n) họa tiết thêu, vải thêu", "Gợi ý: Embroidery", "3"],
  ["Worship", "v) thờ", "Gợi ý: Worship", "3"],
  ["Ancestor", "n: tổ tiên", "Gợi ý: Ancestor", "3"],
  // Cấu trúc ngữ pháp:
  [
    "Question word",
